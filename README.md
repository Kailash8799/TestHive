...
TestHive is a quiz app that allows users to test their knowledge on a variety of topics. Users can create their own quizzes and share them with their friends. Users can also take quizzes created by other users.
...
TestHive focuses on providing fun and interactive way for users to make and take quizzes.
...
2. Create a database named testhive in MySQL
...
```properties
spring.datasource.url=jdbc:mysql://localhost:3306/testhive
...
[@Kailash8799](https://www.github.com/Kailash8799)
